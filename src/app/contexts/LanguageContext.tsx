...
const translations: Record<Language, Record<string, string>> = {
  id: {
    ...
    // Homepage
    'hero.title': 'SEKOLAH TINGGI',
    'hero.title2': 'TEOLOGI BANDUNG',
    'hero.subtitle': 'Membentuk Pemimpin Kristen yang Transformatif',
  ...
  en: {
    ...
    // Homepage
    'hero.title': 'BANDUNG SCHOOL OF',
    'hero.title2': 'THEOLOGY',
    'hero.subtitle': 'Shaping Transformative Christian Leaders',
