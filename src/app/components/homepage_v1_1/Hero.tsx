        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-center mb-10">
            <div className="border border-white/20 px-12 lg:px-20 py-8 lg:py-16 relative backdrop-blur-sm bg-white/5 rounded-sm w-full lg:w-max">
              <div className="absolute -top-0.5 -left-0.5 w-6 h-6 border-t-2 border-l-2 border-yellow-500" />
              <div className="absolute -bottom-0.5 -right-0.5 w-6 h-6 border-b-2 border-r-2 border-yellow-500" />
              ...
              <MaskText key={'Menghasilkan PASTOR-SCHOLAR yang berdampak dalam konteks pelayanan urban'} type="lines" delay={0.2}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link to="/admissions">
              <Button
                size="lg"
                className="bg-sttb-red text-white hover:!bg-red-700 border-2 border-sttb-red px-8 py-6 text-base uppercase tracking-wider shadow-[0_4px_6px_rgba(220,38,38,0.3)] transition-transform hover:-translate-y-0.5"
              >
