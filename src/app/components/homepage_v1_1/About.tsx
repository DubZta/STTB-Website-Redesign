        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-6xl mx-auto">
          <div>
            <MaskText type="lines" delay={0.1}>
              <p className="text-xl leading-normal text-slate-700 mb-8">
                <span className="text-7xl font-bold text-sttb-navy float-left mr-3 leading-[0.8]">
                  S
                </span>
            ...
            <div className="grid grid-cols-3 gap-4 lg:gap-6">
              {stats.map((stat, index) => (
                <div
                  key={index}
                  className="bg-white p-6 text-center border border-gray-200 transition-all hover:-translate-y-2 hover:border-sttb-red hover:shadow-lg group relative"
                >
                  <div className="absolute top-2 left-2 w-4 h-4 border-l border-t border-transparent group-hover:border-sttb-navy transition-all" />
                  <div className="absolute bottom-2 right-2 w-4 h-4 border-r border-b border-transparent group-hover:border-sttb-navy transition-all" />
                  <div className="text-3xl lg:text-4xl font-bold text-sttb-navy mb-2">
                    {stat.number}
                  </div>
          ...
          <div className="relative group perspective-1000">
            <div className="relative overflow-hidden rounded-t-[40%_20%] border-8 border-white shadow-2xl transition-all duration-700 group-hover:shadow-[0_20px_50px_rgba(11,63,130,0.3)] group-hover:-translate-y-4 group-hover:rotate-x-2">
              ...
              />
              <div className="absolute inset-0 bg-sttb-navy/10 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 lg:mt-20">
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-sttb-navy/5 to-yellow-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

              <div className="absolute inset-0 border-2 border-transparent group-hover:border-sttb-navy/30 rounded-xl transition-all" />

              <div className="absolute top-4 right-4 w-10 h-10 border-t-2 border-r-2 border-sttb-navy/30 opacity-0 group-hover:opacity-100 transition" />

              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-4">
                  <Eye className="w-6 h-6 text-sttb-navy" strokeWidth={2} aria-hidden="true" />
                  <h3 className="text-2xl font-bold text-sttb-navy">
                    Visi
                  </h3>
                </div>
                ...
                {activeSide === 'visi' && (
                  <div className="space-y-3">
                    {visionItems.map(item => (
                      <div key={item.title}>
                        <h4 className="font-semibold text-sttb-navy">
                          {item.title}
                        </h4>
            ...
            >
              ...
              <div className="relative z-10">
                {/* Icon + Title */}
                <div className="flex items-center gap-3 mb-4">
                  <Flag className="w-6 h-6 text-sttb-navy" strokeWidth={2} aria-hidden="true" />
                  <h3 className="text-2xl font-bold text-sttb-navy">
                    Misi
                  </h3>
                </div>
