...
const quickLinks = [
  ...
  return (
    <footer id="footer" className="bg-[#082d5e] text-white pt-20 pb-10 border-t-2 border-yellow-500">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div>
            ...
            <ul className="space-y-3 mt-6">
              ...
              <li className="flex items-start gap-3 text-white/70 text-sm">
                <Phone size={18} className="text-yellow-500 flex-shrink-0 mt-0.5" />
                <span className="font-[Inter]">(+62) 22 601-6454, 607-7920</span>
              </li>
              <li className="flex items-start gap-3 text-white/70 text-sm">
                <Mail size={18} className="text-yellow-500 flex-shrink-0 mt-0.5" />
          ...
          {/* Sumber Daya */}
          <div>
            <h3 className="text-base font-bold mb-6 uppercase tracking-wide relative pb-2 after:absolute after:left-0 after:bottom-0 after:w-8 after:h-px after:bg-yellow-500 font-[Plus_Jakarta_Sans] text-white">
              {'SUMBER DAYA'}
            </h3>
            ...
            <div className="mt-6 bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <div className="flex gap-2 items-stretch">
                <input
                  ...
                  className="flex-1 bg-white text-slate-700 placeholder:text-slate-400 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-500/60 min-w-0"
                />
                <button
                  type="button"
                  className="bg-sttb-red hover:bg-red-700 text-white text-sm font-semibold px-4 py-2 rounded-md shadow-md transition-all whitespace-nowrap h-auto"
                >
                  Subscribe
                </button>
              </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-center items-center gap-4 text-sm text-white">
          <p className="font-[Plus_Jakarta_Sans] text-white">{'Copyright © 2026 Sekolah Tinggi Teologi Bandung. All Rights Reserved.'}</p>
          <span className="hidden md:block text-yellow-500">*</span>
