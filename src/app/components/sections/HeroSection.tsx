      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-4xl">
          ...
          >
            ...
            <span className="block text-3xl md:text-4xl lg:text-5xl font-bold leading-tight"><span className="bg-gradient-to-r from-sttb-red to-red-400 bg-clip-text text-transparent">BANDUNG</span></span>
