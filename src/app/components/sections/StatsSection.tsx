...
export default function StatsSection() {
  ...
  const stats = [
    { value: '30+', label: t('stats.years.label') },
    { value: '2,000+', label: t('stats.alumni.label') },
    { value: '8', label: t('stats.programs.label') },
    { value: '40+', label: t('stats.faculty.label') }, // Contoh penyesuaian label
  ];
