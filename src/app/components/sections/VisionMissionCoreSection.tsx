...
const missions = ['Menyelenggarakan pendidikan teologi berkualitas tinggi yang berbasis Alkitab', 'Mengembangkan pemikiran teologis yang relevan dengan konteks Indonesia', 'Membentuk karakter Kristiani yang matang dan profesional', 'Melayani gereja dan masyarakat melalui penelitian dan pengabdian'];
  const values = [
    { icon: Book, title: 'Biblical Excellence', desc: 'Komitmen terhadap kebenaran Alkitab dan keunggulan akademis' },
    { icon: Heart, title: 'Christ-Centered', desc: 'Kristus sebagai pusat dari semua pembelajaran dan pelayanan' },
    { icon: Lightbulb, title: 'Transformational', desc: 'Mengubah kehidupan melalui pendidikan teologi yang relevan' },
    { icon: Award, title: 'Professionalism', desc: 'Standar profesional dalam pendidikan dan pelayanan' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-32">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-6 items-end">
          <div className="lg:col-span-5 flex flex-col">
            ...
            >
              <p className="text-lg md:text-xl font-serif italic text-slate-800 leading-relaxed font-medium">"{'Menjadi lembaga pendidikan teologi yang unggul dalam membentuk pemimpin Kristen yang transformatif untuk gereja dan masyarakat.'}"</p>
            </motion.div>
          </div>
          <motion.div 
