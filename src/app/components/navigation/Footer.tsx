...
const resources = [
    { name: 'Perpustakaan', href: '/library' },
    { name: 'Perpustakaan Digital', href: '/digital-library' },
    { name: 'Jurnal Transformatio', href: '/journal' },
    { name: 'Podcast', href: '/podcast' },
    { name: 'Video', href: '/videos' },
    { name: 'Buletin', href: '/bulletin' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <h3 className="font-semibold mb-4 text-lg text-white">{'HUBUNGI KAMI'}</h3>
            <div className="space-y-3 text-sm text-gray-400">
              <div className="flex items-start gap-2">
                <MapPin className="w-5 h-5 flex-shrink-0 mt-0.5 text-gray-400" />
                <span>{'Jl. Durian No. 16, Bandung 40264'}</span>
              </div>
          ...
          <div>
            <h3 className="font-semibold mb-4 text-lg text-white">{'SUMBER DAYA'}</h3>
          ...
          {/* Help Links */}
          <div>
            <h3 className="font-semibold mb-4 text-lg text-white">{'LINK BANTUAN'}</h3>
            <ul className="space-y-2 text-sm text-gray-400">
              {helpLinks.map((link) => (
                <li key={link.name}>
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-400">{'Copyright © 2026 Sekolah Tinggi Teologi Bandung. All Rights Reserved.'}</p>
