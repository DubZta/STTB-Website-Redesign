...
export default function Header() {
  ...
  const navigation = [
    { name: t('nav.home'), href: '/', dropdown: null },
    {
      name: t('nav.about'),
      href: '/about',
      dropdown: [
    ...
    { name: t('nav.academics'), href: '/academics', dropdown: null },
    { name: t('nav.admissions'), href: '/admissions', dropdown: null },
    { name: t('nav.finance'), href: '/finance', dropdown: null },
    {
      name: t('nav.campus_life'),
      href: '/campus-life',
      dropdown: [
        { name: t('nav.campus_life.facilities') || 'Fasilitas', href: '/campus-life/facilities' },
        { name: t('nav.campus_life.student_development') || 'Pembinaan Mahasiswa', href: '/campus-life/student-development' },
        { name: t('nav.campus_life.senate') || 'Senat', href: '/campus-life/senate' },
      ],
    },
  ];
