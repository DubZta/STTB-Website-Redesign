...
export default function VisionMissionPage() {
  ...
  const missionItems = [
    'Menyelenggarakan pendidikan teologi yang holistik dan relevan untuk mempersiapkan pelayan Tuhan yang kompeten.',
    'Mengembangkan komunitas akademik yang berakar pada Firman Tuhan dan responsif terhadap kebutuhan konteks pelayanan.',
    'Memberdayakan seluruh umat Allah untuk membawa dampak transformatif bagi gereja, masyarakat, dan bangsa.',
  ];
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              <span className="text-sttb-red font-bold text-xs tracking-[0.2em] uppercase">STTB Visi &amp; Misi</span>
              <div className="w-12 h-px bg-gray-300" />
            </div>
          </motion.div>
          ...
          >
            <div className="bg-gradient-to-br from-sttb-navy to-blue-800 rounded-xl p-8 shadow-lg mb-6">
              <div className="text-center mb-6">
                <h2 className="text-3xl font-extrabold text-white mb-4">Visi Kami</h2>
                <p className="text-lg text-blue-100 leading-relaxed max-w-4xl mx-auto">
                  ...
                  <span className="italic font-semibold text-white">pastor-scholar</span>{' '}
          ...
          >
            <div className="text-center mb-8">
              <h2 className="text-3xl font-extrabold text-sttb-navy mb-3">Misi Kami</h2>
            </div>

            <div className="grid md:grid-cols-3 gap-5">
              {missionItems.map((mission, num) => (
                <motion.div
                  key={num}
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-sttb-red to-red-400 flex items-center justify-center flex-shrink-0 shadow-md group-hover:scale-110 transition-transform">
                      <span className="text-xl font-bold text-white">{num + 1}</span>
                    </div>
                    <p className="text-sm text-gray-700 leading-relaxed flex-1">{mission}</p>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          >
            <div className="grid lg:grid-cols-12 gap-16 items-start">
              ...
              <div className="lg:col-span-4 space-y-6">
                <h2 className="text-3xl font-extrabold text-sttb-navy">Nilai-Nilai Inti</h2>
