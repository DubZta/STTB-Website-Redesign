...
const ScholarshipCard = ({ category, title, description, benefits, image, icon: Icon, reverse }: any) => (
  ...
  <div className={`flex flex-col ${reverse ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-start mb-24 gap-12 group`}>
    ...
    <div className="lg:w-1/2 relative overflow-hidden rounded-3xl shadow-xl">
      ...
      <div className="absolute inset-0 bg-gradient-to-tr from-sttb-navy/10 via-transparent to-sttb-red/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
    ...
    <div className="lg:w-1/2 flex flex-col justify-start pt-2">
      ...
      <span className="text-sttb-red font-bold tracking-widest text-sm uppercase mb-3">
        {category}
      </span>

      <h3 className="text-4xl font-bold text-sttb-navy mb-6 tracking-tight">
        {title}
      </h3>
        ...
        <ul className="space-y-3">
          {benefits.map((benefit: string, idx: number) => (
            <li key={idx} className="flex items-start gap-3 transition-all duration-300 group-hover:translate-x-1">
              <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-sttb-red" />
    ...
    <div className="bg-white min-h-screen">
      ...
      <AuroraBackground className="h-[80vh] min-h-[600px] overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-sttb-navy/90 to-transparent" />
        </div>
      ...
      <section className="bg-white">
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="grid lg:grid-cols-[1fr_auto_1fr] gap-16 items-start">
            ...
            {/* LEFT */}
            <div className="space-y-4 border border-sttb-navy rounded-3xl p-10 bg-white shadow-sm">

              <span className="text-sttb-red font-bold tracking-widest text-sm uppercase block mb-4">
                FAQ Calon Penerima
              </span>

              <h2 className="text-5xl font-bold text-sttb-navy mb-6 tracking-tight">
                BEASISWA
              </h2>

              <div className="p-8 bg-sttb-navy rounded-3xl text-white relative overflow-hidden">
                ...
                <Button className="bg-sttb-red text-white hover:!bg-red-700 w-full rounded-xl">
                  HUBUNGI KAMI
                </Button>
      ...
      <section className="pt-16 pb-28 bg-slate-50">
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="grid lg:grid-cols-[1fr_auto_1fr] gap-16">
            ...
            {/* SYARAT */}
            <div className="border border-slate-200 hover:border-sttb-navy rounded-3xl p-10 bg-white shadow-sm transition-all duration-300">

              <span className="text-sttb-red font-bold tracking-widest text-sm uppercase block mb-4">
                Syarat & Ketentuan
              </span>

              <h3 className="text-3xl font-bold text-sttb-navy mb-6">
                BEASISWA
              </h3>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={idx} className="flex items-start gap-3 text-sm text-slate-700">
                    <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-sttb-red flex-shrink-0" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
