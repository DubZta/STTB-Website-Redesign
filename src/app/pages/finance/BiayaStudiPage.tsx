  ...
  <div className="mt-6 animate-fadeIn">
    ...
    <div className="overflow-hidden rounded-xl border border-gray-200 shadow-sm bg-white">
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="bg-sttb-navy text-white">
        ...
        <tbody className="divide-y divide-gray-100">
          {data.map((item: any, idx: number) => (
            <tr key={idx} className="hover:bg-gray-50 transition-colors">
              ...
              <td className="px-6 py-4 text-sm font-bold text-sttb-navy text-right">{item.price}</td>
            </tr>
          ))}
        </tbody>
      </table>
        ...
        <ul className="space-y-2">
          {note.map((item: string, idx: number) => (
            <li key={idx} className="text-xs text-slate-600 flex items-start">
              <span className="mr-2 mt-1 text-sttb-red">•</span>
    ...
    <div className="mt-8 flex justify-end">
      <Button className="bg-sttb-red text-white hover:bg-red-700 px-8 py-3 rounded-full shadow-lg group">
        INFO SELENGKAPNYA
    ...
    <div className="bg-white min-h-screen pt-16 pb-24">
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20 text-center">
          ...
          <span className="text-sttb-red uppercase tracking-[0.35em] font-extrabold text-xs block mb-4">
            Biaya
          </span>

          <MaskText type="lines">
            <h1 className="text-7xl md:text-8xl font-black text-sttb-navy leading-[0.85] tracking-tight">
              STUDI
            </h1>
          </MaskText>

          <div className="mt-6 flex justify-center">
            <div className="h-[4px] w-24 bg-gradient-to-r from-sttb-red to-sttb-navy rounded-full"></div>
          </div>
          ...
          {programs.map(program => (
            ...
            <div
              ...
              className={`
                ...
                hover:shadow-xl hover:shadow-sttb-navy/10
                hover:-translate-y-1 hover:scale-[1.03]

                ${activeProgram.id === program.id
                  ? "ring-2 ring-sttb-red shadow-xl shadow-red-500/20"
                  : ""
                }
              `}
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex justify-between items-start mb-4">
                  ...
                  {activeProgram.id === program.id && (
                    <div className="w-3 h-3 bg-sttb-red rounded-full animate-pulse"></div>
                  )}
                ...
                {program.subtitle && (
                  <p className="text-xs text-sttb-red font-bold uppercase tracking-wider mb-2">
                    {program.subtitle}
                  </p>
                )}
