...
const userTypes = [
    { value: 'student', label: 'Mahasiswa', color: 'sttb-navy' },
    { value: 'staff', label: 'Staff/Dosen', color: 'sttb-red' },
    { value: 'alumni', label: 'Alumni', color: 'purple-600' },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-sttb-navy to-blue-800 rounded-3xl p-12 text-white shadow-2xl">
              <div className="mb-8">
                ...
                <p className="text-xl text-blue-100">
                  {
                    "Akses ke sistem akademik, perpustakaan digital, dan layanan kampus lainnya"
                  }
                </p>
              </div>
              ...
              <div className="mt-12 pt-8 border-t border-white/20">
                <p className="text-sm text-blue-100">
                  Belum punya akun? Hubungi bagian administrasi untuk
                  mendapatkan kredensial login Anda.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-2xl border border-gray-100">
            <div className="mb-8">
              ...
              <p className="text-gray-600">{"Masuk ke akun STTB Anda"}</p>
            </div>
            ...
            <form className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <a
                  href="#"
                  className="text-sm font-semibold text-sttb-navy hover:text-blue-800 transition-colors"
                >
                  Lupa password?
                </a>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <p className="text-center text-sm text-gray-600">
                ...
                <a
                  href="/contact"
                  className="font-semibold text-sttb-navy hover:text-blue-800 transition-colors"
                >
                  Hubungi Support
                </a>
              </p>
            ...
            <div className="lg:hidden mt-8 p-6 bg-gray-50 rounded-2xl">
              <p className="text-sm text-gray-600">
                💡 <strong>Tips:</strong> Belum punya akun? Hubungi bagian
                administrasi untuk mendapatkan kredensial login Anda.
              </p>
            </div>
          </div>
        </div>
