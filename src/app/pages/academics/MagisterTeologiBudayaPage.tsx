...
export default function MagisterTeologiBudayaPage() {
  const curriculumRef = useRef<any>(null);

  const programInfo = {
    code: "M.Th.",
    name: "Magister Teologi",
    subName: "Konsentrasi Transformasi Budaya & Masyarakat",
    nameEn: "Master of Theology (Cultural & Societal Transformation)",
  ...
  const profilLulusan = [
    { title: "Cultural Analyst", desc: "Lulusan mampu menganalisis pergeseran budaya secara kritis dengan kacamata pandang Alkitabiah." },
    { title: "Contextual Theologian", desc: "Merumuskan aplikasi teologi terapan yang relevan dan menjawab tantangan lokal maupun global." },
    { title: "Societal Catalyst", desc: "Menjadi pelaksana dan katalisator misi pembaruan dalam berbagai sendi kehidupan bermasyarakat." },
  ];

  const description = {
    overview: "Program M.Th. Transformasi Budaya & Masyarakat mempersiapkan para pemimpin teologis yang memfokuskan dirinya pada panggilan misi kultural gereja (cultural mandate). Anda akan dididik untuk mengkritisi isu-isu kontemporer, politik, fenomena digital, dan sosiokultural menggunakan apologetika Kristen yang komprehensif, untuk menuntun gereja menjadi garam dan terang yang relevan di era modern.",
    objectives: [
      "Menganalisis perkembangan isu-isu global (ideologi, gender, hak asasi) melalui bingkai Reformed",
      "Mengembangkan kerangka pikir Apologetika Budaya yang taktis dan bermartabat",
      "Memimpin gerakan sosial kemasyarakatan dari basis jemaat lokal",
      "Memfasilitasi diskusi lintas agama dan budaya demi terwujudnya kedamaian (shalom)",
    ],
    careerPaths: [
      "Teolog Peneliti (Research Theologian)",
      "Pemikir Publik / Etikawan Kristen",
      "Pegiat Lembaga Swadaya Kristen (NGO)",
      "Pendidik / Dosen Apologetika Terapan",
      "Perancang Kurikulum Sosial-Gerejawi",
    ],
  };

  const studySystem = {
    keterangan: [
      "Perkuliahan pascasarjana difokuskan pada seminar literatur dan bedah kasus (Case Study).",
      "Mewajibkan mahasiswa melakukan studi etnografi atau sosial riset terapan.",
      "Kolaborasi multi-disiplin diwajibkan dalam penyelesaian tugas tengah semester.",
      "Tesis wajib mengangkat sebuah fenomena masyarakat/budaya yang memiliki signifikansi langsung untuk pergerakan pelayanan gereja masa kini.",
    ],
  };

  const curriculum = {
    "Mata Kuliah Inti / Core": [
      { code: "TEO501", name: "Teologi Biblika Post-Modern", sks: 3 },
      { code: "TEO503", name: "Etika Sosial Kristen", sks: 3 },
      { code: "SYS501", name: "Kristologi dan Penebusan Kultural", sks: 3 },
      { code: "PRA501", name: "Pengantar Apologetika Integrasi", sks: 3 },
    ],
    "Konsentrasi Budaya & Masyarakat": [
      { code: "CUL601", name: "Hermeneutika Kebudayaan", sks: 3 },
      { code: "CUL602", name: "Teologi Publik dan Keadilan Sosial", sks: 3 },
      { code: "CUL603", name: "Tinjauan Kritis Media & Teknologi Era 5.0", sks: 3 },
      { code: "CUL604", name: "Agama-Agama dan Dialog Pluralitas", sks: 3 },
      { code: "CUL605", name: "Sosiologi Agama", sks: 3 },
    ],
    "Riset dan Implementasi": [
      { code: "RST602", name: "Metodologi Riset Kualitatif", sks: 3 },
      { code: "PRK602", name: "Studi Lapangan / Ekskursi Sosial", sks: 4 },
    ],
    "Tugas Akhir": [
      { code: "THS710", name: "Penulisan Tesis Lanjut", sks: 6 },
      { code: "PUB710", name: "Seminar Karya Ilmiah & Jurnal", sks: 2 },
    ],
  };

  const requirements = {
    requirement: [
      "Lulusan S1 Teologi (S.Th/S.Pd.K) dengan IPK minimal 2.75.",
      "Pengalaman melayani dalam konteks jemaat atau pelayanan umum (yayasan sosial/marketplace) min. 2 tahun.",
      "Menyerahkan satu paper argumen teologis terkait satu isu sosial modern.",
      "Memiliki kemampuan baca literatur Bahasa Inggris yang memadai (skor TOEFL/PTES setara disarankan).",
      "Lulus seleksi wawancara dan potensi akademik.",
    ],
  };
        ...
        <section className="pt-28 pb-24 bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-sttb-navy">Societal Transformers</h2>
            </motion.div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                ...
                <h2 className="text-2xl font-extrabold text-sttb-navy mb-8">Bidang Pengabdian</h2>
