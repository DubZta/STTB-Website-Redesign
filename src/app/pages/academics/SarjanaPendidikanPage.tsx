...
export default function SarjanaPendidikanPage() {
  ...
  const profilLulusan = [
    { title: "Informed", desc: "Pendidik Kristen yang berpengetahuan luas dan aplikatif terhadap tantangan perkembangan dunia pendidikan." },
    { title: "Transformed", desc: "Pembelajar yang memiliki fondasi spiritualitas yang kokoh dan matang." },
    { title: "Transformative", desc: "Pendidik handal yang berdampak bagi sekolah, jemaat, dan lingkungan tempatnya melayani." },
  ];

  const description = {
    overview: "Program Sarjana Pendidikan Kristen dirancang untuk mempersiapkan pendidik-pendidik Kristen yang berdedikasi. Program ini mengintegrasikan fondasi alkitabiah yang kuat dengan ilmu dan praktik kependidikan modern, sehingga lulusan kami mampu menjadi guru agama Kristen maupun pelayan di bidang edukasional dengan standar profesional yang tinggi.",
    objectives: [
      "Menghasilkan lulusan yang memiliki pemahaman Alkitabiah dan ilmu pendidikan yang kokoh",
      "Membentuk pendidik yang berkarakter Kristiani, berintegritas, dan berdedikasi pada amanat agung",
      "Mengembangkan keterampilan pedagogik yang relevan dengan perkembangan zaman dan teknologi",
      "Mempersiapkan agen perubahan dalam dunia pendidikan Kristen di berbagai institusi",
    ],
    careerPaths: [
      "Guru Pendidikan Agama Kristen",
      "Kepala Sekolah Kristen",
      "Pengelola Yayasan Pendidikan",
      "Pengajar Teologi Dasar",
      "Konselor Sekolah",
      "Pengembang Kurikulum Rohani",
    ],
  };
  ...
  const studySystem = {
    keterangan: [
      ...
      "Perkuliahan akan berlangsung selama 7 semester dan dilanjut dengan praktik PPL (Kependidikan) selama 6 bulan.",
  ...
  const curriculum = {
    ...
    "Mata Kuliah Kependidikan": [
      { code: "MPK01", name: "Dasar-Dasar Pendidikan", sks: 2 },
      { code: "MPK02", name: "Filsafat Pendidikan Kristen", sks: 3 },
      { code: "MPK03", name: "Psikologi Pendidikan", sks: 3 },
      { code: "MPK04", name: "Pendidikan Agama Kristen Anak", sks: 3 },
      { code: "MPK05", name: "Pendidikan Agama Kristen Remaja", sks: 3 },
      { code: "MPK06", name: "Pendidikan Agama Kristen Dewasa", sks: 3 },
      { code: "MPK07", name: "Strategi Pembelajaran", sks: 3 },
      { code: "MPK08", name: "Perencanaan Pengajaran", sks: 2 },
      { code: "MPK09", name: "Evaluasi Pembelajaran", sks: 3 },
      { code: "MPK10", name: "Media Pembelajaran", sks: 2 },
      { code: "MPK11", name: "Profesi Kependidikan", sks: 2 },
      { code: "MPK12", name: "Manajemen Pendidikan", sks: 2 },
    ],
    ...
    "Mata Kuliah Praktik Lapangan": [
      { code: "PL01", name: "Micro Teaching", sks: 2 },
      { code: "PL02", name: "Praktik Pengalaman Lapangan (PPL)", sks: 6 },
      { code: "PL03", name: "Praktik Pelayanan Mahasiswa", sks: 2 },
    ],
    "Mata Kuliah Tugas Akhir": [
      { code: "TA01", name: "Skripsi / Proyek Kependidikan", sks: 6 },
    ],
  };
  ...
  const requirements = {
    requirement: [
      ...
      "Memiliki panggilan jelas sebagai rohaniwan atau pendidik Kristen.",
      "Memiliki kemampuan dasar Bahasa Inggris yang baik, membaca dan memahami teks.",
        ...
        <section className="pt-28 pb-24 bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-sttb-navy">Transformative Educator</h2>
            </motion.div>
