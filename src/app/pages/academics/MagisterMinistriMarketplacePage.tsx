...
export default function MagisterMinistriMarketplacePage() {
  ...
  const programInfo = {
    ...
    subName: "Konsentrasi Marketplace Ministry",
    nameEn: "Master of Ministry (Marketplace)",
  ...
  const profilLulusan = [
    { title: "Marketplace Apostle", desc: "Lulusan yang dipanggil untuk membawa dampak injil langsung di ranah bisnis, korporasi, dan pemerintahan." },
    { title: "Ethical Professional", desc: "Menjadi profesional dengan standar etika Alkitabiah tinggi yang mengubah budaya kerja." },
    { title: "Resource Mobilizer", desc: "Mampu memobilisasi sumber daya ekonomi untuk mendukung perluasan Kerajaan Allah dan misi lokal." },
  ];

  const description = {
    overview: "Program Magister Ministri Konsentrasi Marketplace Ministry di STT Bandung didesain untuk memperlengkapi kaum profesional Kristen, pengusaha, praktisi medis, hingga ASN yang ingin menjadikan profesi mereka sebagai mimbar utama bagi kemuliaan Kristus. Anda akan diajak melihat pekerjaan sekuler bukan sekadar profesi, melainkan ladang penginjilan yang strategis.",
    objectives: [
      "Menggali fondasi Teologi Kerja (Theology of Work) secara komprehensif",
      "Membangun keterampilan etika bisnis Kristen dalam menghadapi dilema korporasi post-modern",
      "Menyusun strategi misi holistik di lingkungan perusahaan multinasional",
      "Melatih kaum profesional berintegrasi sebagai gembala sekuler di dunia kerja",
    ],
    careerPaths: [
      "CEO / Sociopreneur Berwawasan Misi",
      "Birokrat / Pejabat Publik Kristen",
      "Konsultan Etika Bisnis (Corporate Chaplain)",
      "Pemimpin Yayasan Filantropi Kristen",
      "Pimpinan Pelayanan Profesional (Full Gospel)",
    ],
  };

  const studySystem = {
    keterangan: [
      "Jadwal kuliah disesuaikan untuk para eksekutif dan profesional (Evening / Weekend Classes).",
      "Pembelajaran menggunakan studi kasus nyata (Corporate Case Studies).",
      "Pengumpulan proyek akhir berbasis inovasi pelayaan di tempat kerja masing-masing.",
      "Terdapat sesi mentoring eksklusif bersama para pakar marketplace Kristen terkemuka.",
    ],
  };

  const curriculum = {
    "Fondasi Teologi Kerja": [
      { code: "MKT501", name: "Teologi Kerja dan Vokasi Dasar", sks: 3 },
      { code: "MKT502", name: "Etika Bisnis Kristen Kontemporer", sks: 3 },
      { code: "MKT503", name: "Spiritualitas Kaum Profesional", sks: 2 },
      { code: "MKT504", name: "Kepemimpinan Pelayan (Servant Leadership)", sks: 3 },
    ],
    "Konsentrasi Marketplace": [
      { code: "MKT601", name: "Strategi Misi di Dunia Korporat", sks: 3 },
      { code: "MKT602", name: "Paradigma Kerajaan Allah dalam Ekonomi", sks: 3 },
      { code: "MKT603", name: "Kemitraan Gereja & Dunia Usaha", sks: 3 },
      { code: "MKT604", name: "Misi Transformatif Lintas Institusi", sks: 3 },
    ],
    "Praktek dan Observasi": [
      { code: "PRA610", name: "Praktikum Pelayanan di Tempat Kerja", sks: 4 },
      { code: "MNT610", name: "Mentoring Eksklusif Marketplace Leader", sks: 2 },
    ],
    "Riset dan Tesis": [
      { code: "RST620", name: "Metodologi Riset Teologi Terapan", sks: 3 },
      { code: "THS720", name: "Tesis Magister", sks: 6 },
    ],
  };

  const requirements = {
    requirement: [
      "Lulusan S1 dari semua bidang ilmu (S.Th / S.Pd.K disarankan, S1 Umum dapat masuk dengan matrikulasi).",
      "Aktif bekerja di sektor profesi / bisnis minimal 2 tahun.",
      "Melampirkan esai motivasi penggabungan iman dan pekerjaan (500 kata).",
      "Lulus seleksi wawancara dengan direktur program.",
      "Bersedia mengikuti kelas reguler weekend atau malam.",
    ],
  };
        ...
        <section className="pt-28 pb-24 bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-sttb-navy">Kingdom Professionals</h2>
            </motion.div>
