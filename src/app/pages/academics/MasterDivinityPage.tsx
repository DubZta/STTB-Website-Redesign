...
export default function MasterDivinityPage() {
return (
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mb-10">
            <div className="bg-gradient-to-br from-green-600 to-green-800 rounded-xl p-8 text-white shadow-lg">
              <h1 className="text-4xl font-extrabold mb-2">M.Div.</h1>
              <p className="text-2xl font-semibold text-green-100">Master of Divinity</p>
            </div>
          </motion.div>
