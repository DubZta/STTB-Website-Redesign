  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <h1 className="text-2xl font-bold text-sttb-navy tracking-tight">News & Articles</h1>
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          <Button onClick={handleCreateClick} className="bg-sttb-navy hover:bg-sttb-navy-dark text-white rounded-xl h-11 px-8 font-bold shadow-lg shadow-sttb-navy/20 transition-all active:scale-95">
                  ...
                  <TableCell className="px-6">
                    <div className="flex flex-col gap-0.5 text-slate-500">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[12px] font-medium">{formatDate(item.publishedAt)}</span>
                      </div>
                    </div>
                  </TableCell>
