...
export default function AdminLayout({ children, title }: AdminLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex font-sans selection:bg-blue-100 selection:text-blue-900">
      ...
      <aside
        className={`fixed top-0 left-0 h-full w-[260px] bg-[#0f172a] border-r border-slate-800 z-50 flex flex-col transform transition-all duration-300 lg:translate-x-0 lg:static lg:z-auto ${
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full group flex items-center gap-3.5 px-4 py-3 rounded-xl text-xs font-bold transition-all duration-200 text-left border border-transparent ${
                  isActive
